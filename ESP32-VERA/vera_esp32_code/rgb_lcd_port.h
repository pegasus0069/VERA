...
#define EXAMPLE_LCD_PIXEL_CLOCK_HZ      (16 * 1000 * 1000) ///< Pixel clock frequency in Hz (16MHz stable panel timing to prevent PSRAM DMA underflow)
...
#define EXAMPLE_RGB_BOUNCE_BUFFER_SIZE  (EXAMPLE_LCD_H_RES * 20) ///< Internal SRAM bounce buffer (20 lines) to eliminate PSRAM DMA underflow/jitter
